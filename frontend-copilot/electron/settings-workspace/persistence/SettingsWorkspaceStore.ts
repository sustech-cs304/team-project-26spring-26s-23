...
export interface SettingsWorkspaceStore {
  loadState: () => Promise<{
...
export interface CreateSettingsWorkspaceStoreOptions {
  paths: SettingsWorkspacePaths
  fileSystem?: Partial<SettingsWorkspaceFileSystem>
}

export type SettingsWorkspaceStoreFileSystem = SettingsWorkspaceFileSystem

export function createSettingsWorkspaceStore(
  options: CreateSettingsWorkspaceStoreOptions,
