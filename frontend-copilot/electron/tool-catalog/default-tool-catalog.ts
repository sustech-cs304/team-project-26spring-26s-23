...
function createDefaultToolCatalog(): RuntimeToolDirectoryEntry[] {
  return [
    ...
    // ---- Built-in Browser Tools ----
    {
      ...
      availability: 'available',
      displayName: '打开浏览器页面',
      displayNameZh: '打开浏览器页面',
      displayNameEn: 'Browser Open',
      description: '在桌面浏览器窗口中打开指定URL，可返回页面内容。',
      descriptionZh: '在桌面运行时浏览器窗口中打开一个URL，可选择返回页面内容。',
      descriptionEn: 'Open a URL in the desktop runtime browser window with optional content extraction.',
      group: {
        id: 'browser',
        label: '浏览器工具',
        labelZh: '浏览器工具',
    ...
    },
    {
      ...
      displayName: '浏览器截图',
      displayNameZh: '浏览器截图',
      displayNameEn: 'Browser Screenshot',
      description: '对当前浏览器页面截图，返回PNG图片。',
      descriptionZh: '截取当前桌面运行时浏览器页面的PNG截图。',
      descriptionEn: 'Capture a PNG screenshot of the current browser page.',
      group: {
        id: 'browser',
        label: '浏览器工具',
        labelZh: '浏览器工具',
    ...
    {
      toolId: 'browser.list_tabs',
      kind: 'builtin',
      availability: 'available',
      displayName: '列出浏览器标签页',
      displayNameZh: '列出浏览器标签页',
      displayNameEn: 'List Browser Tabs',
      description: '列出所有打开的浏览器标签页及其URL和标题。',
      descriptionZh: '列出所有打开的浏览器标签页，包含ID、URL和标题信息。',
      descriptionEn: 'List all open browser tabs with their IDs, URLs, and titles.',
      group: {
        id: 'browser',
        label: '浏览器工具',
        labelZh: '浏览器工具',
    ...
    {
      toolId: 'browser.close_tab',
      kind: 'builtin',
      availability: 'available',
      displayName: '关闭浏览器标签页',
      displayNameZh: '关闭浏览器标签页',
      displayNameEn: 'Close Browser Tab',
      description: '按标签页ID关闭指定浏览器标签页。',
      descriptionZh: '按标签页ID关闭指定浏览器标签页。',
      descriptionEn: 'Close a browser tab by its ID.',
      group: {
        id: 'browser',
        label: '浏览器工具',
        labelZh: '浏览器工具',
    ...
    {
      toolId: 'browser.switch_tab',
      kind: 'builtin',
      availability: 'available',
      displayName: '切换浏览器标签页',
      displayNameZh: '切换浏览器标签页',
      displayNameEn: 'Switch Browser Tab',
      description: '切换到指定标签页ID的浏览器窗口。',
      descriptionZh: '切换到指定标签页ID的浏览器窗口。',
      descriptionEn: 'Switch to a specific browser tab by its ID.',
      group: {
        id: 'browser',
        label: '浏览器工具',
        labelZh: '浏览器工具',
    ...
    {
      toolId: 'browser.execute',
      kind: 'builtin',
      availability: 'available',
      displayName: '执行浏览器脚本',
      displayNameZh: '执行浏览器脚本',
      displayNameEn: 'Execute Browser Script',
      description: '在浏览器页面中执行JavaScript，可用于点击、填表、数据提取。',
      descriptionZh: '在当前浏览器页面中执行JavaScript代码。',
      descriptionEn: 'Execute JavaScript in the current browser page for clicking, filling forms, or data extraction.',
      group: {
        id: 'browser',
        label: '浏览器工具',
        labelZh: '浏览器工具',
    ...
    {
      toolId: 'browser.reset',
      kind: 'builtin',
      availability: 'available',
      displayName: '重置浏览器',
      displayNameZh: '重置浏览器',
      displayNameEn: 'Reset Browser',
      description: '关闭所有浏览器窗口并清除浏览器状态。',
      descriptionZh: '关闭所有打开的浏览器窗口并清除浏览器状态。',
      descriptionEn: 'Close all open browser windows and clear browser state.',
      group: {
        id: 'browser',
        label: '浏览器工具',
        labelZh: '浏览器工具',
    ...
    },
    {
      ...
      availability: 'available',
      displayName: '浏览器页面快照',
      displayNameZh: '浏览器页面快照',
      displayNameEn: 'Browser Snapshot',
      description: '获取页面可访问性快照，交互元素带编号引用。',
      descriptionZh: '获取当前浏览器页面的可访问性快照，交互元素带有编号引用标记。',
      descriptionEn: 'Capture an accessibility snapshot with interactive elements annotated by reference IDs.',
      group: {
        id: 'browser',
        label: '浏览器工具',
        labelZh: '浏览器工具',
