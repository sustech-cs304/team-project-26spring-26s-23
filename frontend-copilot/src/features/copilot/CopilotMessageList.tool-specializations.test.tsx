...
describe('CopilotMessageList specialized tool cards', () => {
  it('renders file read tools with a semantic reading card instead of raw JSON chrome', async () => {
    ...
    expect(rendered.getByTestId('chat-message-tool-raw-toggle-0')).not.toBeNull()
    expect(rendered.queryByTestId('chat-message-tool-output-0-json')).toBeNull()
    await clickElement(rendered.getByTestId('chat-message-tool-raw-toggle-0'))
    ...
    await clickElement(rendered.getByTestId('chat-message-tool-input-toggle-0'))
    expect(rendered.getByTestId('chat-message-tool-input-0-json')).not.toBeNull()
