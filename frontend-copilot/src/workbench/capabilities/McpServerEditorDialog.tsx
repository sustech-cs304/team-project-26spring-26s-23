...
export function McpServerEditorDialog({
      ...
      >
        ...
        <div className="capabilities-dialog__body">
          <div className="capabilities-dialog__toolbar">
            <button
              type="button"
              className={`secondary-button secondary-button--subtle${step === 'form' ? ' capabilities-dialog__tab-button--active' : ''}`}
            ...
            <button
              type="button"
              className={`secondary-button secondary-button--subtle${step === 'import' ? ' capabilities-dialog__tab-button--active' : ''}`}
          ...
          {errorMessage || formValidationErrors.length > 0 ? (
            <div className="capabilities-dialog__errors" role="alert">
  ...
  function updateFormState(nextState: McpServerFormState) {
  ...
  function handleParseImport() {
    ...
    if (result.candidates.length === 1) {
      applyImportedCandidate(result.candidates[0])
    }
  }

  function applyImportedCandidate(candidate: StandardMcpImportCandidate) {
