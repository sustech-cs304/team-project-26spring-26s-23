...
const THINKING_SOURCE_SETTINGS = 'settings-page' as const
const GEMINI_25_BUDGET_V1 = 'gemini-2.5-budget-v1'
...
describe('ProviderModelEditorDialog', () => {
  ...
  describe('thinking value display', () => {
        ...
        <ProviderModelEditorDialog
          modelEditorState={createModelEditorState({
            thinkingCapability: {
              ...
              source: THINKING_SOURCE_SETTINGS,
            },
          })}
          modelEditorError={null}
          onClose={vi.fn()}
