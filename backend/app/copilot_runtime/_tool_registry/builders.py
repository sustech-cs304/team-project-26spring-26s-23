...
from .constants import (
    ...
    SHELL_SESSION_CLOSE_PARAMETERS_JSON_SCHEMA,
    ...
    SHELL_SESSION_EXEC_PARAMETERS_JSON_SCHEMA,
    ...
    SHELL_SESSION_START_PARAMETERS_JSON_SCHEMA,
    ...
    registry.register(
        ToolsetDescriptor(
            ...
            tools=(
                ...
                ExecutableTool(
                    descriptor=ToolDescriptor(
                        tool_id=SHELL_RUN_TOOL_ID,
                        kind=DEFAULT_TOOL_KIND,
                        display_name=SHELL_RUN_TOOL_DISPLAY_NAME,
                        description=SHELL_RUN_TOOL_DESCRIPTION,
                        availability=DEFAULT_TOOL_AVAILABILITY,
                        prompt=SHELL_RUN_TOOL_PROMPT,
                        presentation=TOOL_PRESENTATION_BY_ID[SHELL_RUN_TOOL_ID],
                    ),
                    execute=execute_shell_run_tool,
                    function_name="shell_run",
                    parameters_json_schema=SHELL_RUN_PARAMETERS_JSON_SCHEMA,
                ),
                ExecutableTool(
                    descriptor=ToolDescriptor(
                        tool_id=SHELL_SESSION_START_TOOL_ID,
                        kind=DEFAULT_TOOL_KIND,
                        display_name=SHELL_SESSION_START_TOOL_DISPLAY_NAME,
                        description=SHELL_SESSION_START_TOOL_DESCRIPTION,
                        availability=DEFAULT_TOOL_AVAILABILITY,
                        prompt=SHELL_SESSION_START_TOOL_PROMPT,
                        presentation=TOOL_PRESENTATION_BY_ID[SHELL_SESSION_START_TOOL_ID],
                    ),
                    execute=execute_shell_session_start_tool,
                    function_name="shell_session_start",
                    parameters_json_schema=SHELL_SESSION_START_PARAMETERS_JSON_SCHEMA,
                ),
                ExecutableTool(
                    descriptor=ToolDescriptor(
                        tool_id=SHELL_SESSION_EXEC_TOOL_ID,
                        kind=DEFAULT_TOOL_KIND,
                        display_name=SHELL_SESSION_EXEC_TOOL_DISPLAY_NAME,
                        description=SHELL_SESSION_EXEC_TOOL_DESCRIPTION,
                        availability=DEFAULT_TOOL_AVAILABILITY,
                        prompt=SHELL_SESSION_EXEC_TOOL_PROMPT,
                        presentation=TOOL_PRESENTATION_BY_ID[SHELL_SESSION_EXEC_TOOL_ID],
                    ),
                    execute=execute_shell_session_exec_tool,
                    function_name="shell_session_exec",
                    parameters_json_schema=SHELL_SESSION_EXEC_PARAMETERS_JSON_SCHEMA,
                ),
                ExecutableTool(
                    descriptor=ToolDescriptor(
                        tool_id=SHELL_SESSION_CLOSE_TOOL_ID,
                        kind=DEFAULT_TOOL_KIND,
                        display_name=SHELL_SESSION_CLOSE_TOOL_DISPLAY_NAME,
                        description=SHELL_SESSION_CLOSE_TOOL_DESCRIPTION,
                        availability=DEFAULT_TOOL_AVAILABILITY,
                        prompt=SHELL_SESSION_CLOSE_TOOL_PROMPT,
                        presentation=TOOL_PRESENTATION_BY_ID[SHELL_SESSION_CLOSE_TOOL_ID],
                    ),
                    execute=execute_shell_session_close_tool,
                    function_name="shell_session_close",
                    parameters_json_schema=SHELL_SESSION_CLOSE_PARAMETERS_JSON_SCHEMA,
                ),
                ExecutableTool(
                    descriptor=ToolDescriptor(
