...
class ThreadModel(Base):
    ...
    last_assistant_message_preview: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
...
class RunModel(Base):
    ...
    selected_model_route_json: Mapped[dict[str, Any]] = mapped_column(
        JSON, nullable=False, default=dict
    )
    resolved_model_route_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    resolved_model_id: Mapped[str | None] = mapped_column(String(256), nullable=True)
    requested_thinking_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    applied_thinking_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    thinking_capability_override_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    ...
    tool_permission_policy_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    resolved_tool_ids_json: Mapped[list[str] | None] = mapped_column(
        JSON, nullable=True
    )
    request_options_json: Mapped[dict[str, Any]] = mapped_column(
        JSON, nullable=False, default=dict
    )
    ...
    failure_details_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
...
class ThreadProjectionModel(Base):
    ...
    last_effective_model_snapshot_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    last_effective_tools_snapshot_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    drift_summary_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    timeline_preview_json: Mapped[list[dict[str, Any]] | None] = mapped_column(
        JSON, nullable=True
    )
    updated_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False, default=_utcnow
    ...
    __table_args__ = (
        Index("ix_thread_projection_last_activity_at", "last_activity_at"),
    )
...
class RunProjectionModel(Base):
    ...
    timeline_items_json: Mapped[list[dict[str, Any]] | None] = mapped_column(
        JSON, nullable=True
    )
    tool_call_blocks_json: Mapped[list[dict[str, Any]] | None] = mapped_column(
        JSON, nullable=True
    )
    diagnostic_blocks_json: Mapped[list[dict[str, Any]] | None] = mapped_column(
        JSON, nullable=True
    )
    terminal_state_json: Mapped[dict[str, Any] | None] = mapped_column(
        JSON, nullable=True
    )
    updated_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False, default=_utcnow
